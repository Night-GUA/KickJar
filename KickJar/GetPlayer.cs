...
static class GetPlayer
{
    ...
    public static ClientData GetClientById(this int id)
    {
        try
        {
    ...
    public static string GetColorRole(this PlayerControl pc)
    {
        return Utils.ColorString(Utils.GetRoleColor(pc.Data.RoleType),pc.Data.Role.NiceName);
    }
    public static string GetRoleColorName(this PlayerControl pc,string name)
    {
        return Utils.ColorString(Utils.GetRoleColor(pc.Data.RoleType),name);
    }
    ...
    public static RoleBehaviour getBehaviourByRoleType(this RoleTypes roleType) {
